      ...
      {featured && (
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-black via-night to-night-light p-8">
          <div className="max-w-2xl">
            <p className="mb-3 text-xs uppercase tracking-[0.4em] text-ember">À L'AFFICHE</p>
          ...
          <img
            src={featured.thumbnailUrl || 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=1200&q=60'}
            alt={featured.title}
